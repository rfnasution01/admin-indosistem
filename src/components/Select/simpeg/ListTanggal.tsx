    ...
    <FormField
      ...
      render={({ field }) => {
        return (
          <FormItem
            className={cn(
              `${isBulan ? 'z-10' : 'z-20'} flex w-full items-center gap-12 text-[2rem] text-warna-dark phones:flex-col phones:items-start phones:gap-12 phones:text-[2.4rem]`,
              className,
            )}
          >
            {headerLabel && (
            ...
            <div className="w-3/5 phones:w-full">
              <FormControl>
                <Select
                  ...
                  className={`${isBulan ? 'z-10' : 'z-20'} text-[2rem]`}
                  options={data}
