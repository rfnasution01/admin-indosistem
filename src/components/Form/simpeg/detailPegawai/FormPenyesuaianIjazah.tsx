...
export function FormPenyesuaianIjazah({
  form,
  isLoading,
  isTambah,
  setIsShow,
    ...
    <Form {...form}>
      ...
      >
        ...
        <FormLabelInput
          name={`tanggal_stlupi`}
          form={form}
          label="Tanggal STLUPI"
          placeholder="Tanggal STLUPI"
          className="w-full hover:cursor-not-allowed phones:w-full "
          type="text"
          isDisabled={disabled}
          isRow
        ...
        <FormLabelInput
          ...
          form={form}
          label="Pejabat Penandatangan Sertifikat"
          placeholder="Pejabat Penandatangan Sertifikat"
          className="w-full hover:cursor-not-allowed phones:w-full "
          type="text"
          isDisabled={disabled}
          isRow
        ...
        <FormLabelInput
          name={`penandatangan_nilai`}
          form={form}
          label="Pejabat Penandatangan Nilai"
          placeholder="Pejabat Penandatangan Nilai"
          className="w-full hover:cursor-not-allowed phones:w-full "
          type="text"
          isDisabled={disabled}
          isRow
