...
import { PreviewSlider } from '@/features/website/konten'
import { validateURL } from '@/utils/validate'

export default function FormTambahSlider({
  form,
  isLoading,
  handleSubmit,
  setUrls,
          ...
          <div className="flex justify-end">
            <button
              ...
              onClick={async () => {
                ...
                const isNotUrlUndefined = form?.watch('url') !== undefined
                const isNotUrlString = form?.watch('url') !== ''
