...
import { MenubarActionDaftarPegawai } from '../Menubar/MenubarDaftarPegawaiTable'
...
type Props<T extends DaftarPegawai, P> = {
  data: T[]
...
export function TableDaftarPegawai<T extends DaftarPegawai, P>({
  data,
  columns,
  containerClasses = '',
