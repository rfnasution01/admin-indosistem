...
import {
  ...
  useGetUserMenuQuery,
} from '@/store/slices/user/identitasType'
import { GetUserIdentitasType } from '@/types/user/identitasType'
import { LinkParent } from '../website/mainLayout/LinkParent'
import { LinkChild } from '../website/mainLayout/LinkChild'
...
export function UserMainHeader({
  ...
  const isActivePage = (item: string) => {
    if (
      (item.toLowerCase() === 'home' && secondPathname === undefined) ||
